...
//
//	@Override
//	public int compare(Airport o1, Airport o2) { // shut the comparator up 
...
//	public int compare(Airport o1, Airport o2, String crit) {
//		switch(crit) {
//		case "delay":
//			return flight.delay;
//		case "canceled":
...
//}
	...
	public class NetworkGraph {
		...
		public BestPath getBestPath(String origin, String destination, FlightCriteria criteria) {
			...
			PriorityQueue<Airport> pq = new PriorityQueue<Airport>(50, comp);
		...
		public void populate(String flightInfo) throws FileNotFoundException {
			...
			while (s.hasNextLine()) {
				...
				if (!airports.containsKey(origin.name)) {
					...
					totalAirports.add(origin); // add to list so we can easily reset it
				}
